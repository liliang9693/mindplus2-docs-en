...
* After downloading, please review the PDF tutorial included in the compressed file (e.g., “Mind+V2.X Extension Library Offline Installation Guide.pdf”) before proceeding.
