...
![image](./311MenuBar.assets/pic_1780472710823.png)
...
![image](./311MenuBar.assets/pic_1780473001468.png)
...
![image](./311MenuBar.assets/pic_1780473744671.png)
...
Supports editing operations, allows you to restore deleted characters, and lets you turn on/off tubro mode to improve coding efficiency.

![image](./311MenuBar.assets/pic_1780473984474.png)

**Restore**: Restores the character, look, sound, or background deleted in the previous step. However, this is different from the Undo/Redo functions.

**Turn On/Off turbo Mode**: Turn Turbo Mode on or off. When enabled, the stage program runs faster and response times are reduced. When enabled, the text "Turbo Mode" appears at the top of the stage.

![image](./311MenuBar.assets/pic_1780474464631.png)
...
![image](./311MenuBar.assets/pic_1780475112615.png)
