...
| ![image](./3337AdvancedTypes.assets/pic_1781078565543.png) | Retrieve a specific element in a list by its index; you can retrieve it in ascending or descending order.多模型翻译对比                                                                   |
